...
$word.Quit()
 ...
 　
Function ExcelTopdf($folderpath){
...
$myfile = "e:\test\"
pptTopdf -folderpath $myfile
#excelTopdf -folderpath $myfile
wordTopdf -folderpath $myfile
